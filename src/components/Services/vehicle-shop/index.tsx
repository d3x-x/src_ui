...
class VehicleShop extends Component<Props, State> {
	...
	async buy() {
		...
		try {
			...
			showNotification(
				'success',
				'Ви успiшно придбали ТЗ, доставити його можна через програму в телефонi'
			);
		} catch ( err: any ) {
			...
			<div className="vehicle-shop">
				...
				<div className="vehicle-shop_main">
					...
					<div className="vehicle-shop_buttons">
						...
						<GradientButton onClick={this.buy.bind( this )}>Купити</GradientButton>
					</div>
				</div>
			</div>
		);
