	...
	render() {
		...
		return (
			<div className="vehicle-dump">
				<PrimaryTitle className="vehicle-dump_title">Утилiзацiя ТЗ</PrimaryTitle>

				<div className="vehicle-dump_container">
					<div className="vehicle-dump_info">
						<div className="vehicle-dump_info-item">
						Марка та модель: <b>{(vehicleList as any)[model] || model}</b>
						</div>
					</div>

					<TotalPrice className="vehicle-dump_price" title="Отримайте:" value={price} />
				</div>

				<div className="vehicle-dump_footer">
					<OutlineButton isClose>Вiдмiна</OutlineButton>
