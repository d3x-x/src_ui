	...
	render() {
		...
		return recipient ? (
			<div className="player-cash">
				<PrimaryTitle className="player-cash_title">Передача готiвки</PrimaryTitle>
				...
				<div className="player-cash_footer">
					<OutlineButton onClick={this.closeMenu.bind(this)}>Вiдмiна</OutlineButton>
					<GradientButton form="cash">Передати</GradientButton>
				</div>
			</div>
		) : null;
	}
