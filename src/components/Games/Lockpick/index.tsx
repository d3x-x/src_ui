	...
	render() {
		...
		return (
			<div className="lockpick">
				<PrimaryTitle className="lockpick_title">Зламування транспорту</PrimaryTitle>
				...
				<div className="lockpick_container">
					...
					<div className="lockpick_info">
						<Hint action="click">Натиснiть у центрi кола</Hint>

						<p className="lockpick_info-item">
							Влучте <b>{need}</b> {need > 4 ? 'раз' : 'раза'} у кiльце
						</p>
					</div>
				</div>
