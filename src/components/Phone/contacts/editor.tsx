...
export default function ContactEditor({ contact, save, remove, close }: Props) {
	return (
		<div className="contacts_editor">
			<Navigation
				close={{ title: 'Скасувати', onClick: close }}
			...
			>
				<Form id="contact-editor">
					<Group>
						<Field type="text" name="firstName" placeholder="iм'я" component={Input} />
						<Field type="text" name="lastName" placeholder="Прiзвище" component={Input} />
						<Field
							type="text"
							name="phone"
